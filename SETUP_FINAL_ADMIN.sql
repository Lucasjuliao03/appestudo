-- Script FINAL para configurar admin com emails
...
-- 3. Criar função principal para listar todos os usuários com emails
...
SELECT 'Todas as funções criadas com sucesso!' as status;

-- Testar (apenas para admins)
-- SELECT * FROM public.get_users_with_emails();
