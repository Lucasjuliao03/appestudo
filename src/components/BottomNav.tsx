...
import { Home, BookOpen, Layers, ClipboardList, User, Shield } from "lucide-react";
...
export function BottomNav() {
  ...
  useEffect(() => {
    if (!loading) {
      console.log('🔐 BottomNav - isAdmin:', isAdmin, 'loading:', loading);
    }
  }, [isAdmin, loading]);

  // Só mostrar Admin se não estiver carregando e for admin
  const allNavItems = (!loading && isAdmin)
